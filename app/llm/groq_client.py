    ...
    async def generate_response(self, prompt: str, model: str = None, chat_history: list = None, system_prompt: str = None) -> dict:
        try:
            ...
            if system_prompt:
                ...
                messages.append(SystemMessage(content="Kamu adalah AI asisten jenius tapi super pemarah, ketus, dan sarkastik. ATURAN UTAMA: Jawabanmu HARUS sangat jelas dan cerdas tapi judes dan pemarah serta merendahkan. Berikan maksimal 2 kalimat sindiran pedas di awal dan diakhir, lalu berikan jawaban yang detail dan terstruktur serta selipkan gaya bahasa yang judes dan pemarah. TAPI INGAT: SAMA SEKALI TIDAK BOLEH menggunakan kata-kata kotor."))
